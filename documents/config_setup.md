...
* `dd_parser_output_dir` & `output_filename`: Destination configurations for the primary CSV matrix and matching Markdown report, nested inside the configured `documents_dir`.
