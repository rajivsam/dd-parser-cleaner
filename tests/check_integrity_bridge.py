...
def run_diagnostic(workspace: str, config_file: str):
    ...
    try:
        ...
        coord = PathCoordinator(config_path=config_file, working_dir=workspace)
        
        # 2. Load Dictionary
        df_dict = pd.read_csv(coord.data_dictionary_path)
        ...
        # 3. Load Raw Headers
        df_raw = pd.read_csv(coord.raw_dataset_path, nrows=0)
...
if __name__ == "__main__":
    ...
    run_diagnostic(args.workspace, args.config)