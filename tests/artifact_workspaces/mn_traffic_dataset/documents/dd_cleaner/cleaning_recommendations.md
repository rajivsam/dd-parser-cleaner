...
|:------------|:------------|:----------------|:----------------------------------------------------------|:------------------|
| holiday     | categorical | Regional Events | Extreme sparsity (99.9%): Exceeds null threshold of 95.0% | drop-attribute    |

## Derived attribute definition or deletion is recommended

| Attribute   | Type     | Entity        | What Needs Fixing                                                                                                                                    | Recommended Fix            |
|:------------|:---------|:--------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------|:---------------------------|
| date_time   | datetime | Time and Date | This is a cross sectional dataset; if you want to use the datetime attributes, you need to derive numeric attributes from them and then delete them. | custom:datetime_to_numeric |
