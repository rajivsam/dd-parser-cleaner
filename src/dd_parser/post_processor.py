...
class MetadataPostProcessor:
    ...
    def _build_dataset_manifest(self, df: pd.DataFrame, dataset_type: str, use_case_answers: Dict[str, Any] = None) -> Dict[str, Any]:
        ...
        use_case_answers = use_case_answers or self.paths.config.get("use_case_answers", {})
        ...
        manifest = {
            ...
            "graph_type": self.paths.config.get("graph_type"),
            "subject": self.paths.config.get("subject"),
            "subject_id_attribute": self.paths.config.get("cleaner", {}).get("structural_assessment", {}).get("subject_id_attribute"),
            "wide_short_homogeneous": self.parser_config.get("wide_short_homogeneous", False),
            "wide_short_representative_column": self.parser_config.get("wide_short_representative_column"),
    ...
    def _write_handshake_file(
        ...
        handshake_payload = {
            ...
            "dataset_type": dataset_manifest.get("dataset_type"),
            "graph_type": dataset_manifest.get("graph_type") or "Not applicable",
            "subject": dataset_manifest.get("subject") or "Not applicable",
            "subject_id_attribute": dataset_manifest.get("subject_id_attribute") or "Not applicable",
            "wide_short_homogeneous": dataset_manifest.get("wide_short_homogeneous", False),
            "wide_short_representative_column": dataset_manifest.get("wide_short_representative_column") or "Not applicable",
            "use_case_answers": dataset_manifest.get("use_case_answers", {}),
