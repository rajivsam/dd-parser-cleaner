...
def main():
    ...
    config = {
        ...
        "subject": bootstrap_metadata.get("subject"),
        "subject_id_attribute": bootstrap_metadata.get("subject_id_attribute"),
        "graph_type": bootstrap_metadata.get("graph_type"),
        "use_case_answers": bootstrap_metadata.get("use_case_answers", {}),
        "notes": bootstrap_metadata.get("notes"),
